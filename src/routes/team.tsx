  ...
  return (
    <AppShell>
      <PageHeader
        ...
        subtitle="Developer productivity, contributions, and performance."
      />
        ...
        {contributors.map((c) => (
          <Card key={c.name} className="p-5">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-full bg-brand-gradient text-white grid place-items-center font-semibold shrink-0">
                {c.avatar}
              </div>
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-center">
              <div className="rounded-lg bg-muted/60 py-2">
                <div className="text-sm font-semibold">{c.commits}</div>
                <div className="text-[10px] text-muted-foreground">Commits</div>
              </div>
              <div className="rounded-lg bg-muted/60 py-2">
                <div className="text-sm font-semibold">{c.closed}</div>
                <div className="text-[10px] text-muted-foreground">Issues</div>
              </div>
              <div className="rounded-lg bg-muted/60 py-2">
                <div className="text-sm font-semibold">{c.reviews}</div>
            ...
            <div className="mt-4">
              ...
              <div className="h-2 rounded-full bg-muted overflow-hidden">
                <div className="h-full bg-brand-gradient" style={{ width: `${c.score}%` }} />
              </div>
            </div>
          </Card>
        ))}
